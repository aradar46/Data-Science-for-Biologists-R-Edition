# Exercises — Module 8: Survival Analysis and Omics Integration

Work through these exercises after completing the Module 8 notebook.

---

## Exercise 8.1 — Censoring scenarios
...
## Exercise 8.2 — Kaplan-Meier interpretation

Using the KM curve from Module 8:
...
## Exercise 8.3 — Cox model extension
...
## Exercise 8.4 — Validation split for omics Cox

Using the penalized Cox from Module 8:
...
4. Report the difference. What does this gap tell you about the in-sample C-index reported in Module 8?

---

## Exercise 8.5 — Risk group reporting

A colleague argues that the high/low risk group split shown in Module 8 is publishable evidence for a clinical biomarker.
